...
`,mi=({filterText:e,onFilter:t,onClear:n})=>Oe.jsxs(Oe.Fragment,{children:[Oe.jsx(hi,{id:"search",type:"text",placeholder:"Keyword","aria-label":"Search Input",value:e,onChange:t}),Oe.jsx(Xr,{className:"h-[33px] rounded-none rounded-r-lg",onClick:n,children:"X"})]});pi("custom",{text:{primary:"inherit",secondary:"inherit"},background:{default:"inherit"},context:{background:"inherit",text:"inherit"},sortFocus:{default:"inherit"}},"dark");const bi={headRow:{style:{color:"#fff",backgroundColor:"rgb(31 41 55)",fontSize:"15px"}}};function vi({title:e,url:t,columns:n,data:r}){const[o,a]=i.useState({current_page:1,per_page:10,total:0,data:r}),[s,l]=i.useState(!1),[d,g]=i.useState(""),[u,f]=i.useState(!1),x=new AbortController,h=x.signal,b=!!t;let R=[];b||(R=i.useMemo(()=>o.data.filter(m=>{const C=Object.values(m).join("-");return C&&C.toLowerCase().includes(d.toLowerCase())}),[d,u]));const O=async(m,C,S="")=>{if(b){l(!0);const p=await Zr.get(`${t}?page=${m}&per_page=${C}&q=${S}`,{signal:h});a(p.data),l(!1)}};i.useEffect(()=>(O(o.current_page,o.per_page,d),()=>{x.abort()}),[o.current_page,o.per_page,d]);const E=i.useMemo(()=>{const m=()=>{f(!u),g("")};return Oe.jsx(mi,{onFilter:C=>g(C.target.value),onClear:m,filterText:d})},[d,u]),$=async(m,C)=>{a(S=>({...S,current_page:C,per_page:m}))},w=async m=>{a(C=>({...C,current_page:m}))};return Oe.jsx("span",{className:"dark:bg-gray-800 dark:text-white",children:Oe.jsx(fi,{title:e,columns:n,data:b?o.data:R,progressPending:s,pagination:!0,paginationServer:b,paginationTotalRows:o.total,paginationResetDefaultPage:u,onChangeRowsPerPage:$,onChangePage:w,subHeader:!0,subHeaderComponent:E,persistTableHead:!0,theme:"custom",fixedHeader:!0,fixedHeaderScrollHeight:"500px",customStyles:bi})})}export{vi as P};
