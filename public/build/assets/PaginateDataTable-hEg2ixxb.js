...
`,Aa=D.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var _a=i.memo(function({column:e,disabled:t,draggingColumnId:n,selectedColumn:r={},sortDirection:o,sortIcon:a,sortServer:s,pagination:l,paginationServer:d,persistSelectedOnSort:g,selectableRowsVisibleOnly:u,onSort:f,onDragStart:x,onDragOver:h,onDragEnd:b,onDragEnter:R,onDragLeave:O}){i.useEffect(()=>{typeof e.selector=="string"&&console.error(`Warning: ${e.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)},[]);const[E,$]=i.useState(!1),w=i.useRef(null);if(i.useEffect(()=>{w.current&&$(w.current.scrollWidth>w.current.clientWidth)},[E]),e.omit)return null;const m=()=>{if(!e.sortable&&!e.selector)return;let T=o;Je(r.id,e.id)&&(T=o===ve.ASC?ve.DESC:ve.ASC),f({type:"SORT_CHANGE",sortDirection:T,selectedColumn:e,clearSelectedOnSort:l&&d&&!g||s||u})},C=T=>i.createElement(Pa,{sortActive:T,sortDirection:o}),S=()=>i.createElement("span",{className:[o,"__rdt_custom_sort_icon__"].join(" ")},a),p=!(!e.sortable||!Je(r.id,e.id)),_=!e.sortable||t,U=e.sortable&&!a&&!e.right,Y=e.sortable&&!a&&e.right,Q=e.sortable&&a&&!e.right,ae=e.sortable&&a&&e.right;return i.createElement(ka,{"data-column-id":e.id,className:"rdt_TableCol",$headCell:!0,allowOverflow:e.allowOverflow,button:e.button,compact:e.compact,grow:e.grow,hide:e.hide,maxWidth:e.maxWidth,minWidth:e.minWidth,right:e.right,center:e.center,width:e.width,draggable:e.reorder,$isDragging:Je(e.id,n),onDragStart:x,onDragOver:h,onDragEnd:b,onDragEnter:R,onDragLeave:O},e.name&&i.createElement(Ia,{"data-column-id":e.id,"data-sort-id":e.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:_?void 0:m,onKeyPress:_?void 0:T=>{T.key==="Enter"&&m()},$sortActive:!_&&p,disabled:_},!_&&ae&&S(),!_&&Y&&C(p),typeof e.name=="string"?i.createElement(Aa,{title:E?e.name:void 0,ref:w,"data-column-id":e.id},e.name):e.name,!_&&Q&&S(),!_&&U&&C(p)))});const ja=D(Ve)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
...
`;function Na({contextMessage:e,contextActions:t,contextComponent:n,selectedCount:r,direction:o}){const a=br(o),s=r>0;return n?i.createElement(Mn,{$visible:s},i.cloneElement(n,{selectedCount:r})):i.createElement(Mn,{$visible:s,$rtl:a},i.createElement(Ha,null,((l,d,g)=>{if(d===0)return null;const u=d===1?l.singular:l.plural;return g?`${d} ${l.message||""} ${u}`:`${d} ${u} ${l.message||""}`})(e,r,a)),i.createElement(Fa,null,t))}const Ma=D.div`
	position: relative;
	box-sizing: border-box;
	overflow: hidden;
	display: flex;
